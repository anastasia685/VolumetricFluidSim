...
LPCWSTR g_szAppName = L"Direct3DDemo";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"Direct3DDemoWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"Direct3DDemoWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
            nullptr, nullptr, hInstance,
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"Direct3DDemoWindowClass", g_szAppName, WS_POPUP,
